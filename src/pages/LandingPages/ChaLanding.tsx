...
export const ChaLanding = () => {
  ...
  // Buscar imagens de antes/depois e vídeos do chá do banco de dados
  const beforeAfterImages = getActiveItems();
  const chaVideos = videos.cha || [];
  ...
  // Buscar avaliações reais do produto
  const customerReviews = product?.customerReviews?.filter(review => review.verified !== false).slice(0, 6) || [];
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-16 text-center">
                <div>
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <p className="text-5xl font-bold text-gray-900">{product.rating?.toFixed(1) || '5.0'}</p>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <p className="text-5xl font-bold text-gray-900">{product.reviews || 0}</p>
                  </div>
                  <p className="text-gray-600 font-medium">Avaliações</p>
                </div>
                <div>
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <FiHeart className="text-red-500 w-8 h-8" />
                    <p className="text-5xl font-bold text-gray-900">98%</p>
                  </div>
                  <p className="text-gray-600 font-medium">Recomendariam</p>
                </div>
              </div>
            )}
          </div>
